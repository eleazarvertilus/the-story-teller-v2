    ...
    return (
        <div className="Inclusive-changePass-page" >
            <form onSubmit={handleSubmit}>
                ...
                {success && <div className="success_msg">{success}<Link to="/profile">Retour au profil</Link>  </div>}
                ...
                <div className="input-wrapper">
                    ...
                    <input type={isRevealPass1 ? "text" : "password"}
                        autoComplete='off'
                        id="old_password" placeholder="Ancien mot de passe  " name='old_password'
                        required
                        value={oldPassword}
                ...
                <div className="input-wrapper">
                    <input type={isRevealPass3 ? "text" : "password"}
                        id="confirm_password"
                        autoComplete='off'
                        placeholder="Confirmer le mot de passe  " name='confirm_password'
